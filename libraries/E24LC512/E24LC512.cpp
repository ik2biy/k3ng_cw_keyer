...
E24LC512::E24LC512(void)
{
    Wire.begin();
}


void E24LC512::write(unsigned long dataAddress, uint8_t data) 
{

    Wire.beginTransmission(0x50);
    Wire.write((int)(dataAddress >> 8)); //writes the MSB
    Wire.write((int)(dataAddress & 0xFF)); //writes the LSB
    Wire.write(data);
...
uint8_t E24LC512::read(unsigned long dataAddress) 
{
  uint8_t data = 0xFF;
  Wire.beginTransmission(0x50);
  Wire.write((int)(dataAddress >> 8)); //writes the MSB
