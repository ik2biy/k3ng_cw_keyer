...
#ifdef FEATURE_EEPROM_E24LC512 
  #include <E24LC512.h>
  #define EEPROM EEPROM512
...
void write_settings_to_eeprom(int initialize_eeprom) {  
  ...
  #if !defined(ARDUINO_SAM_DUE) || (defined(ARDUINO_SAM_DUE) && defined(FEATURE_EEPROM_E24C1024)) || (defined(ARDUINO_GENERIC_STM32F103C) && defined(FEATURE_EEPROM_E24LC512))

    //if (initialize_eeprom == 0) {
  ...
  #endif //!defined(ARDUINO_SAM_DUE) || (defined(ARDUINO_SAM_DUE) && defined(FEATURE_EEPROM_E24C1024)) || (defined(ARDUINO_GENERIC_STM32F103C) && defined(FEATURE_EEPROM_E24LC512))
...
void initialize_keyer_state(){
  ...
  #else
    #if (defined(ARDUINO_GENERIC_STM32F103C) && !defined(FEATURE_EEPROM_E24LC512))//ik2biy
      memory_area_end = memory_flash_size;//ik2biy
    #elif (defined(ARDUINO_GENERIC_STM32F103C) && defined(FEATURE_EEPROM_E24LC512))//ik2biy
      memory_area_end = ext_eeprom_size;//ik2biy
    #else
      memory_area_end = 1024; //ik2biy standard eeprom length
    #endif  
  #endif
}  
...
void check_eeprom_for_initialization(){
  ...
  if (paddle_pin_read(paddle_left) == LOW && paddle_pin_read(paddle_right) == LOW) 
  {
    ...
    #if defined(HARDWARE_GENERIC_STM32F103C) //ik2biy
      Serial.println("EEPROM formatting, may take long time..... please wait"); //ik2biy
      for(int address = 0; address <= memory_area_end; address++) //ik2biy
      { //ik2biy
        EEPROM.write(address, 0x00); //ik2biy
      } //ik2biy
      Serial.println("EEPROM formatting complete..... resuming"); //ik2biy
    #endif //ik2biy   
